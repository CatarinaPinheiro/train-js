...
if (total < carro.assentos){
    ...
    mensagem = "Já temos " + total + " pessoas no carro!";
} else if (total === carro.assentos ){
    carro.quantidadePessoas += numeroPessoas;
    mensagem = "O carro já está lotado!";
} else if (quantidadePessoasCabem >= 0 && quantidadePessoasCabem !=1 && total >= carro.assentos){
    carro.quantidadePessoas = carro.assentos;
    mensagem = "Só cabem mais " + quantidadePessoasCabem + " pessoas!";
}
else if (quantidadePessoasCabem >= 0 && quantidadePessoasCabem ==1 && total >= carro.assentos){
    carro.quantidadePessoas = carro.assentos
    mensagem = "Só cabe mais " + quantidadePessoasCabem + " pessoa!";
}
return mensagem
}
...
// Faça o carro encher.
carro.adicionarPessoas(0); //'O carro já está lotado!'
